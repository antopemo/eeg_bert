...
class BertEmbeddingsLayer(Layer):
    ...
    def call(self, inputs, mask=None, training=None):
        ...
        input_ids = tf.reshape(input_ids, [tf.shape(input_ids)[0], input_ids.shape[1], self.params.hidden_size])
        ...
        # Para poder simular que la input es el embedding, el embedding es igual a la input
